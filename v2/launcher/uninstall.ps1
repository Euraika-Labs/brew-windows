...
$runtimeManifest = Join-Path $resolvedPrefix "runtime-manifest.json"
if (-not (Test-Path -LiteralPath $marker -PathType Leaf) -and
    -not (Test-Path -LiteralPath $brewScript -PathType Leaf) -and
